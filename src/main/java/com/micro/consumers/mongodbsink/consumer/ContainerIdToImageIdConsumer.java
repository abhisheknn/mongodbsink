...
public class ContainerIdToImageIdConsumer extends ConsumerThread {
	...
	private InsertOptions insertOptions= new InsertOptions();
	...
	public ContainerIdToImageIdConsumer(MongoConnection connection, String brokers, String groupId, String topic) {
		super(brokers, groupId, topic);
		client = connection.getMongo();
		database = client.getDatabase("dockerx");
		collection = database.getCollection("containerToImageId");
